...
export default function App() {
  ...
  function sBadgeClass(stk: string) {
    ...
    if (stk==="st7") return "sbadge s-customs";
      ...
      <div className="at-root" onClick={() => setShowLang(false)}>
        ...
        {view==="stats" && adminUser && (()=>{
          ...
          const statusData = [
            ...
            {name:"Retardés",value:delayed,color:"#f06120"},
          ].filter(s=>s.value>0);

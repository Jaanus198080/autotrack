...
const T: Record<string, Record<string, string>> = {
  ...
  es: { flag:"🇪🇸",track:"Seguimiento",search:"Buscar",back:"Volver",loading:"Cargando...",err_not_found:"Número no encontrado.",adm_title:"Crear seguimiento",adm_sub:"Complete el formulario",err_fill:"Complete todos los campos.",gen_btn:"Generar número",upd_btn:"Actualizar posición",login_title:"Acceso Admin",login_email:"Email",login_pass:"Contraseña",login_btn:"Conectarse",login_err:"Email o contraseña incorrectos.",logout:"Cerrar sesión",copy:"Copiar",copied:"¡Copiado!",reg_title:"Crear cuenta",reg_email:"Email",reg_pass:"Contraseña",reg_btn:"Crear cuenta gratis",reg_ok:"¡Cuenta creada!",reg_err:"Error.",pay_title:"Elegir pack",lbl_client:"CLIENTE",lbl_vehicle:"VEHÍCULO",lbl_route:"RUTA",lbl_mt:"Transporte",lbl_carr:"Transportista",lbl_dd:"Fecha salida",lbl_eta:"Llegada estimada",lbl_vin:"VIN",lbl_pl:"Matrícula",st0:"En espera",st1:"Cargado",st2:"En tránsito",st3:"En aduana",st4:"En entrega",st5:"Entregado",st6:"Suspendido",st7:"Retrasado" },,
  pt: { flag:"🇵🇹",track:"Rastreamento",search:"Pesquisar",back:"Voltar",loading:"Carregando...",err_not_found:"Número não encontrado.",adm_title:"Criar rastreamento",adm_sub:"Preencha o formulário",err_fill:"Preencha todos os campos.",gen_btn:"Gerar número",upd_btn:"Atualizar posição",login_title:"Acesso Admin",login_email:"Email",login_pass:"Senha",login_btn:"Entrar",login_err:"Email ou senha incorretos.",logout:"Sair",copy:"Copiar",copied:"Copiado!",reg_title:"Criar conta",reg_email:"Email",reg_pass:"Senha",reg_btn:"Criar conta grátis",reg_ok:"Conta criada!",reg_err:"Erro.",pay_title:"Escolher pack",lbl_client:"CLIENTE",lbl_vehicle:"VEÍCULO",lbl_route:"ROTA",lbl_mt:"Transporte",lbl_carr:"Transportadora",lbl_dd:"Data saída",lbl_eta:"Chegada estimada",lbl_vin:"VIN",lbl_pl:"Placa",st0:"Aguardando",st1:"Carregado",st2:"Em trânsito",st3:"Na alfândega",st4:"Em entrega",st5:"Entregue",st6:"Suspenso",st7:"Atrasado" },,
  el: { flag:"🇬🇷",track:"Παρακολούθηση",search:"Αναζήτηση",back:"Πίσω",loading:"Φόρτωση...",err_not_found:"Ο αριθμός δεν βρέθηκε.",adm_title:"Δημιουργία",adm_sub:"Συμπληρώστε τη φόρμα",err_fill:"Συμπληρώστε όλα τα πεδία.",gen_btn:"Δημιουργία αριθμού",upd_btn:"Ενημέρωση",login_title:"Admin",login_email:"Email",login_pass:"Κωδικός",login_btn:"Σύνδεση",login_err:"Λάθος στοιχεία.",logout:"Αποσύνδεση",copy:"Αντιγραφή",copied:"Αντιγράφηκε!",reg_title:"Δημιουργία",reg_email:"Email",reg_pass:"Κωδικός",reg_btn:"Δωρεάν λογαριασμός",reg_ok:"Δημιουργήθηκε!",reg_err:"Σφάλμα.",pay_title:"Επιλογή",lbl_client:"ΠΕΛΆΤΗΣ",lbl_vehicle:"ΌΧΗΜΑ",lbl_route:"ΔΙΑΔΡΟΜΉ",lbl_mt:"Μεταφορά",lbl_carr:"Μεταφορέας",lbl_dd:"Αναχώρηση",lbl_eta:"Άφιξη",lbl_vin:"VIN",lbl_pl:"Πινακίδα",st0:"Αναμονή",st1:"Φορτωμένο",st2:"Σε διαμετακόμιση",st3:"Τελωνείο",st4:"Παράδοση",st5:"Παραδόθηκε",st6:"Ανεσταλμένο",st7:"Καθυστερημένο" },,
  nl: { flag:"🇳🇱",track:"Volgen",search:"Zoeken",back:"Terug",loading:"Laden...",err_not_found:"Nummer niet gevonden.",adm_title:"Tracking aanmaken",adm_sub:"Vul het formulier in",err_fill:"Vul alle velden in.",gen_btn:"Genereer nummer",upd_btn:"Positie bijwerken",login_title:"Admin",login_email:"Email",login_pass:"Wachtwoord",login_btn:"Inloggen",login_err:"Onjuiste gegevens.",logout:"Uitloggen",copy:"Kopiëren",copied:"Gekopieerd!",reg_title:"Account aanmaken",reg_email:"Email",reg_pass:"Wachtwoord",reg_btn:"Gratis account",reg_ok:"Account aangemaakt!",reg_err:"Fout.",pay_title:"Kies pakket",lbl_client:"KLANT",lbl_vehicle:"VOERTUIG",lbl_route:"ROUTE",lbl_mt:"Vervoer",lbl_carr:"Vervoerder",lbl_dd:"Vertrek",lbl_eta:"Aankomst",lbl_vin:"VIN",lbl_pl:"Kenteken",st0:"Wachten",st1:"Geladen",st2:"Onderweg",st3:"Douane",st4:"Bezorging",st5:"Bezorgd",st6:"Opgeschort",st7:"Vertraagd" },,
  pl: { flag:"🇵🇱",track:"Śledzenie",search:"Szukaj",back:"Wróć",loading:"Ładowanie...",err_not_found:"Numer nie znaleziony.",adm_title:"Utwórz śledzenie",adm_sub:"Wypełnij formularz",err_fill:"Wypełnij wszystkie pola.",gen_btn:"Generuj numer",upd_btn:"Aktualizuj",login_title:"Admin",login_email:"Email",login_pass:"Hasło",login_btn:"Zaloguj",login_err:"Błędne dane.",logout:"Wyloguj",copy:"Kopiuj",copied:"Skopiowano!",reg_title:"Utwórz konto",reg_email:"Email",reg_pass:"Hasło",reg_btn:"Darmowe konto",reg_ok:"Konto utworzone!",reg_err:"Błąd.",pay_title:"Pakiet",lbl_client:"KLIENT",lbl_vehicle:"POJAZD",lbl_route:"TRASA",lbl_mt:"Transport",lbl_carr:"Przewoźnik",lbl_dd:"Wyjazd",lbl_eta:"Przyjazd",lbl_vin:"VIN",lbl_pl:"Tablice",st0:"Oczekiwanie",st1:"Załadowany",st2:"W tranzycie",st3:"Cło",st4:"Dostawa",st5:"Dostarczony",st6:"Wstrzymany",st7:"Opóźniony" }
};
...
export default function App() {
  const [lang, setLangState] = useState(()=>{
    const s=["fr","en","de","hr","it","bg","ro","es","pt","el","nl","pl"];
    const b=(navigator.language||"fr").slice(0,2).toLowerCase();
    return s.includes(b)?b:"fr";
  });
